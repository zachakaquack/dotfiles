# Generated by Powerlevel10k configuration wizard on 2025-09-28 at 09:12 CDT.
...
# 24h time, vertical separators, sharp heads, flat tails, 1 line, sparse, few icons,
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=red
  ...
  # zach: added "$fg[red] " to end of it to keep the parentheses style around the git.
  typeset -g POWERLEVEL9K_VCS_CONTENT_EXPANSION='$fg[red](${$((my_git_formatter(1)))+${my_git_format}}$fg[red])'
